...
public:
	...
	string        get_title        () { return m_WorldTitle; };
	...
	float     get_cohesion             () { return m_cohesion; };

	bool        get_useKillZone          () { return m_isKillZone; };
	float2*     get_killZone             () { return Kill_zone; };
